...
function cleanup()
{
    ...
    echo "${ARTIFACT_DIR}"
    #VERBOSE=true os::cmd::expect_success  "echo $JUNIT_REPORT $JUNIT_REPORT_OUTPUT"
...
os::cmd::expect_success "KUBECONFIG='${MASTER_CONFIG_DIR}/admin.kubeconfig'"
os::cmd::expect_success  "oc version"
